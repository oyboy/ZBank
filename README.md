...
## UI-тесты
О структуре:
   * **admin** - здесь находятся тест-кейсы (либо их части) исключительно связанные с тестированием админ-панели
   * **user** - тут только для пользовательского сайта
   * **e2e** - здесь находятся те тест-кейсы, которые сопровождаются изменениями как в ВО, так и на сайте
   * **base** - базовые и конфигурационные классы для тестов
Всего реализовано 8 тест-кейсов
#### Важное
